                    ...
                    loading ? (
                        ...
                        {user.isSeller&&(
                            ...
                            <div>
                                ...
                                <input id='sellerName' type='text' placeholder='Enter Seller Name' value={sellerName}
                                onChange={(e)=>setSellerName(e.target.value)}></input>
                            </div>
                            <div>
                                <label htmlFor='sellerLogo'>Seller Logo</label>
                                <input id='sellerLogo' type='text' placeholder='Enter Seller Logo' value={sellerLogo}
                                onChange={(e)=>setSellerLogo(e.target.value)}></input>
                            </div>
                            <div>
                                <label htmlFor='sellerDescription'>Seller Description</label>
                                <input id='sellerDescription' type='text' placeholder='Enter Seller Description' value={sellerDescription}
